...
public class DynamicImpl implements Dynamic{
	...
	public void insert(Connection connection, DynamicEntity dynamicEntity,ShareEntity shareEntity) throws Exception {
		...
		PreparedStatement pStatement = connection
				.prepareCall("INSERT INTO wehtb.dynamictable" + "(title,content,photo) VALUES(?,?,?)");
		...
		//向share表中插入did等信息
		 pStatement = connection
				.prepareCall("INSERT INTO wehtb.share" + "(uid,did,date) VALUES(?,?,?)");
...
//		connection.commit();
	...
	public ResultSet queryDId(Connection connection, DynamicEntity dynamicEntity,ShareEntity shareEntity) throws SQLException {
		PreparedStatement preparedStatement = connection.prepareStatement("SELECT dynamictable.did from wehtb.dynamictable , wehtb.share where dynamictable.did=share.did AND share.date=?");
